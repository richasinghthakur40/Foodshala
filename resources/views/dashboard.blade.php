...
<head>
    ...
    <form @fade [formGroup]="loginPage" style="text-align:center">
        <table align="center" class="table"
            style="color: black; font-family:'Times New Roman', Times, serif;font-size:x-large;background: linear-gradient(to top right,yellow,lightgreen,green);width: 25%;">
            <tr>
                <th>&nbsp;Login&nbsp;</th>
            </tr>
        </table>
        <table align="center" border="2" class="table"
            style="background: linear-gradient(to bottom right,rgb(244, 247, 79),rgb(10, 204, 194));width: 25%;font-family: 'Times New Roman', Times, serif;">
            <tr>
                <th>&nbsp;Enter SMID</th>
    ...
    <div align="center" *ngIf="alert" class="alert alert-danger alert-dismissible fade show" role="alert"
        ...
        <h3 ><i class="fa fa-envelope" style="font-family: 'Times New Roman', Times, serif; height:35px ;" aria-hidden="true"></i>&nbsp;<a href="C:/xampp/htdocs/foodshala/resources/views/register">Register Here</a></h3>
